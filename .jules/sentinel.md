...
## 2026-07-21 - [CRITICAL] TOCTOU vulnerability when caching validated file paths
...
## 2026-07-22 - [CRITICAL] Untrusted Workspace / Path Traversal Bypass via `promptFile` option
